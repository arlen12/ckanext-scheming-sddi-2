...
'''def ah_schema_set_default(values, default_value):
    ## only set default value if current value is empty string or None
    ## or list thereof
    #added by mandana.... it needs to be defined in helper part of plugin.py
    # referenced from https://lists-archive.okfn.org/pipermail/ckan-dev/2016-June/021444.html
